...
const translations = {
    de: {
        ...
        // Profiles
        'profiles.title': 'Ernährungsprofile',
        'profiles.add': 'Profil hinzufügen',
        'profiles.all_added': 'Alle Profile bereits hinzugefügt!',
        'profiles.new': 'Neues Ernährungsprofil',
        ...
        'profiles.updated': 'Profil aktualisiert!',
